...
install() {
  ...
  echo ""
  echo " 1. Add this public key to your personal GitHub account:"
  echo "    https://github.com/settings/ssh/new"
  echo ""
  cat "$PUB_FILE"
  echo ""
  echo " 2. Point this repo's remote at the personal SSH alias:"
  echo "    git remote set-url origin git@github-personal:peter-slattery/workspace.git"
  echo ""
  echo " 3. Verify: ssh -T git@github-personal"
  echo "================================================================"
}
